...
const Hero = () => {
    ...
    useGSAP(()=>{
      gsap.set('#video-frame',{clipPath: 'polygon(14% 0%, 72% 0%, 88% 90%, 0% 95%)',
      ...
      <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
        <div>
            <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
                <div onClick={handleMiniVdClick} className='origin-center scale-50 opacity-0 hover:scale-100 transition-all duration-500 ease-in hover:opacity-100'>
                    <video 
                    ref={nextVideoRef}
